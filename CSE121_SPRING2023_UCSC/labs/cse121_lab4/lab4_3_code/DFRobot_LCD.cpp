...
void DFRobot_LCD::printstr(const char c[], int row){
...
void DFRobot_LCD::T_H_display(){
    ...
    while (1) {
        ...
        sprintf(temp_buff, "Temp: %.1fC",temperature);
        sprintf(hum_buff, "Hum : %.1f%%",humidity);
        printstr(temp_buff, 0);
        printstr(hum_buff, 1);
...
void DFRobot_LCD::i2c_write(uint8_t reg, uint8_t data) {
